                ...
                <form action="{{ url('vehicles/update/' . $vehicle->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="price"
                                    class="form-control @error('price') is-invalid @enderror" value="{{ $vehicle->price }}">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="long"
                                    class="form-control @error('long') is-invalid @enderror" value="{{ $vehicle->long }}">
                                @error('long')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="wide"
                                    class="form-control @error('wide') is-invalid @enderror" value="{{ $vehicle->wide }}">
                                @error('wide')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <img src="{{ $vehicle->image_url }}" class="width-50">
                        </div>
